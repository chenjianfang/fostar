...
const { CRACO_CONFIG } = require('constants');
 ...
 * @param params
 */
async function traverseCRACO(destinationFolder, params) {
  const pathFile = path.join(destinationFolder, CRACO_CONFIG);
